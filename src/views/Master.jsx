...
const Master = () => {
  ...
  const [userForm, setUserForm] = useState({ name: '', email: '', password: '123', tenantId: '', role: 'aluno', plano: 'Básico', limiteAlunos: 10, telefone: '', endereco: '', dia_vencimento: '' });
  ...
  const openAddUser = (role) => {
    setUserForm({ name: '', email: '', password: '123', tenantId: '', role, plano: 'Básico', limiteAlunos: 10, telefone: '', endereco: '', dia_vencimento: '' });
    setEditingId(null);
    setShowForm('user');
  };
  ...
  const openEditUser = (userObj) => {
    setUserForm({ 
      ...
      dia_vencimento: userObj.dia_vencimento || ''
    });
            ...
            {showForm === 'user' && (
              <form onSubmit={handleSaveUser} style={styles.crudForm} className="animate-fade-in">
                ...
                <div style={styles.formGrid}>
                  ...
                  <div style={styles.inputGroup}>
                    <label style={styles.formLabel}>Telefone / WhatsApp</label>
                    <input 
                      type="text" 
                  ...
                  <div style={styles.inputGroup}>
                    ...
                    <input 
                      ...
                      onChange={(e) => setUserForm(prev => ({ ...prev, endereco: e.target.value }))}
                      style={styles.inputField}
                    />
                  </div>
                  {userForm.role === 'aluno' && (
                    <div style={styles.inputGroup}>
                      ...
                      <input 
                        ...
                        max="31"
                        placeholder="Ex: 5"
                        value={userForm.dia_vencimento || ''} 
                        onChange={(e) => setUserForm(prev => ({ ...prev, dia_vencimento: e.target.value }))}
                        style={styles.inputField}
                      />
                    </div>
                  )}
